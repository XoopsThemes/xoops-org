...
<{foreach item=newitems from=$block.newitems}>
    <tr class="<{cycle values=" even,odd"}>">
        ...
        <td>
            ...
            <br>
            <span style="padding: 3px 16px 0 0; font-size: 11px;"><span class="fas fa-user"></span>&nbsp;<{$newitems.poster}></span>
            <{if $block.show_order == '1'}>
                <span style="padding: 3px 16px 0 0; font-size: 11px;"><span class="fas fa-calendar"></span><{$newitems.new}></span>
            <{/if}>
        </td>
    </tr>
<{/foreach}>
